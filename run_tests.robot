...
Execute BrowserStack Robot Tests
    ...
    Log    Running BrowserStack SDK: browserstack-sdk robot ./Tests/android/SingleTestAndroid.robot    console=True
    ${result}=    Run Process    browserstack-sdk    robot    ./Tests/android/SingleTestAndroid.robot
    ...    cwd=${CURDIR}
    ...    timeout=${TIMEOUT}
